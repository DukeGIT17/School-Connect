...
{
    /// <inheritdoc />
    public partial class AdvancedComprehensiveMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StaffNr = table.Column<string>(type: "TEXT", maxLength: 7, nullable: false),
                    EmailAddress = table.Column<string>(type: "TEXT", nullable: false),
                    PhoneNumber = table.Column<long>(type: "INTEGER", nullable: false),
                    ProfileImage = table.Column<string>(type: "TEXT", nullable: true),
                    Title = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    EmisNumber = table.Column<string>(type: "TEXT", maxLength: 8, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherID = table.Column<long>(type: "INTEGER", nullable: false),
                    ClassID = table.Column<int>(type: "INTEGER", nullable: false),
                    StaffNr = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LearnerID = table.Column<long>(type: "INTEGER", nullable: false),
                    ParentID = table.Column<long>(type: "INTEGER", nullable: false),
                    LearnerIdNo = table.Column<string>(type: "TEXT", maxLength: 13, nullable: false),
                    ParentIdNo = table.Column<string>(type: "TEXT", maxLength: 13, nullable: false)
                },
                constraints: table =>
                {
