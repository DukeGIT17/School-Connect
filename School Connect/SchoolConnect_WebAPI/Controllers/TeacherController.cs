...
namespace SchoolConnect_WebAPI.Controllers
{
    ...
    public class TeacherController(ITeacherService teacherService) : ControllerBase
    {
        ...
        [HttpGet(nameof(GetParentsByTeacherClasses))]
        public IActionResult GetParentsByTeacherClasses(long teacherId)
        {
            try
            {
        ...
        [HttpGet(nameof(GetGradesByTeacher))]
        public IActionResult GetGradesByTeacher(long teacherId)
        {
            try
            {
