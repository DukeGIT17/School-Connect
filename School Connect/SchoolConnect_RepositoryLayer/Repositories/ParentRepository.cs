    ...
    public class ParentRepository : IParent
    {
        ...
        public async Task<Dictionary<string, object>> BatchLoadParentsFromExcelAsync(IFormFile parentSpreadsheet)
        {
            try
            {
                ...
                _returnDictionary = DeleteFile(@"C:\Users\tsoai\Desktop\Git Repo\School-Connect\School Connect\SchoolConnect_DomainLayer\Application Files\Misc\" + parentSpreadsheet.FileName);
